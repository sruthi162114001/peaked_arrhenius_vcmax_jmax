 ...
 *  A reference temperature of 25 degrees C is used.
 *
 *  The following parameters are calculated using a peaked Arrhenius
 *  temperature response (`peaked_arrhenius_response()`) as in Medlyn
 *  et al. (2002).
 *  - `Jmax_norm`
 *  - `Vcmax_norm`
 *  A reference temperature of 25 degrees C is used.
 ...
 *
 *  - [Medlyn B.E., Dreyer E., Ellsworth D., Forstreuter M., Harley P.C., Kirschbaum M.U.F., … Loustau D. 
 *    Plant, Cell & Environment 25, 1167–1179 [2002] (https://onlinelibrary.wiley.com/doi/abs/10.1046/j.1365-3040.2002.00891.x)
 *
 */
